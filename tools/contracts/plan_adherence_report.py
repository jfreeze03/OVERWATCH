...
PHASES: tuple[PhaseSpec, ...] = (
    ...
    PhaseSpec(
        "phase_02a",
        "Instant section summary autoload",
        (
            ".overwatch_final/runtime_boundaries.py",
            ".overwatch_final/utils/runtime_boundaries.py",
            ".overwatch_final/performance.py",
            ".overwatch_final/utils/performance.py",
            ".overwatch_final/query_contracts.py",
            ".overwatch_final/utils/query.py",
            "tools/contracts/summary_autoload_contract.py",
            "tools/contracts/performance_budget_gate.py",
            "tools/contracts/launch_readiness.py",
        ),
        (
            "tests/test_summary_autoload_contract.py",
            "tests/test_runtime_event_ledger.py",
            "tests/test_performance_budget_gate.py",
            "tests/test_full_app_runtime_validation.py",
        ),
        (
            "artifacts/full_app_validation/summary_autoload_contract_results.json",
            "artifacts/launch_readiness/summary_autoload_contract_gate_results.json",
            "artifacts/full_app_validation/source_runtime_event_ledger_results.json",
        ),
        ("Implemented as a release boundary and runtime-ledger gate; summary mart SQL foundation is covered by phase_02b.",),
    ),
    PhaseSpec(
        "phase_02b",
        "COCO Account Usage and summary mart burn-down",
        (
        ...
        (
            ...
            "artifacts/snowflake_validation/summary_mart_setup_results.json",
