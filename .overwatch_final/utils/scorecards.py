...
DBA_CONTROL_PLANE_SECTION_NEXT_MOVES = {
    ...
    "Architecture Readiness": "Persist architecture, Adaptive Compute, AI/MCP, AI-security, Openflow, Horizon, semantic-trust, and DR-drill evidence into mart facts with verified closure history.",
    "Cost & Contract": "Replace placeholder owner rows with named ALFA cost owners, ITSM approval, and verified savings auto-close.",
