...
SELECT
    ...
    'CREATE OR REPLACE TASK "' || DATABASE_NAME || '"."' || SCHEMA_NAME || '"."OVERWATCH_REFRESH_' || OBJECT_NAME || '" WAREHOUSE = OVERWATCH_WH SCHEDULE = ''60 MINUTE'' AS CALL "' || DATABASE_NAME || '"."' || SCHEMA_NAME || '"."SP_OVERWATCH_REFRESH_' || OBJECT_NAME || '"();' AS GENERATED_TASK_STUB_SQL
FROM overwatch_dynamic_collisions
...
SELECT
    ...
    'CREATE OR REPLACE TASK "' || d.REFERENCING_DATABASE || '"."' || d.REFERENCING_SCHEMA || '"."OVERWATCH_REFRESH_' || d.REFERENCING_OBJECT_NAME || '" WAREHOUSE = OVERWATCH_WH SCHEDULE = ''60 MINUTE'' AS CALL "' || d.REFERENCING_DATABASE || '"."' || d.REFERENCING_SCHEMA || '"."SP_OVERWATCH_REFRESH_' || d.REFERENCING_OBJECT_NAME || '"();' AS GENERATED_TASK_STUB_SQL
