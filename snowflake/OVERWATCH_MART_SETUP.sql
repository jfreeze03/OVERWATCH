...
$$
BEGIN
  -- FAST_IMPL is the physically separate fast entrypoint. The shared core is
  -- mode-locked to FAST so full-only windows and optional enrichments stay
  -- guarded by REFRESH_MODE_NORMALIZED.
