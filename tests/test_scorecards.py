...
class ScorecardTests(unittest.TestCase):
    ...
    def test_dba_section_baseline_is_strict_and_repeatable(self):
        ...
        self.assertEqual(by_section["DBA Control Room"]["SCORE"], 91.8)
        ...
        self.assertEqual(by_section["Warehouse Health"]["SCORE"], 91.9)
        ...
        self.assertEqual(by_section["Security Posture"]["SCORE"], 92.6)
