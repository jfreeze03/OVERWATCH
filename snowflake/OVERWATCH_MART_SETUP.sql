...
BEGIN
  ...
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         ...
         cfg.DEFAULT_CONFIDENCE AS CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable') AS ENVIRONMENT_MODE, :snapshot_ts AS SNAPSHOT_TS
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.EXECUTIVE_SCORECARD_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.FORECAST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CLOSED_LOOP_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.PRODUCTION_READINESS_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.DATA_TRUST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.APP_OBSERVABILITY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CONTROL_ROOM_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CORTEX_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COST_SIGNAL_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.VALUE_LEDGER_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.SETTINGS_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.QUERY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.QUERY_DETAIL_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.TASK_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.PROCEDURE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COPY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ALERT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.NOTIFICATION_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ACKNOWLEDGEMENT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ACTION_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.SECURITY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.LOGIN_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.GRANT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.OWNER_COVERAGE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CHANGE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, COALESCE(cfg.ENVIRONMENT_MODE, 'not_applicable'), :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  INSERT INTO MART_SECTION_COMMAND_SOURCE (
    ...
    IS_STALE, CONFIDENCE, ENVIRONMENT_SCOPE_MODE, GAP_REASON, SNAPSHOT_TS, LOAD_TS
  )
  SELECT
    w.BRIEF_ID,
    w.SECTION_NAME,
