    ...
    def test_overwatch_task_warehouses_match_intended_runtime(self):
        ...
        self.assertEqual(
            set(warehouses),
            {
                ...
                "OVERWATCH_LOAD_QUERY_HOURLY",
                "OVERWATCH_LOAD_QUERY_DETAIL",
                "OVERWATCH_LOAD_OBJECT_CHANGE",
                "OVERWATCH_LOAD_TASK_RUN",
                "OVERWATCH_LOAD_PROCEDURE_RUN",
                "OVERWATCH_LOAD_SNAPSHOTS",
                "OVERWATCH_LOAD_TASK_CRITICAL_PATH",
