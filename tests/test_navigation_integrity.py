...
class NavigationIntegrityTests(unittest.TestCase):
    ...
    def test_app_shell_header_renders_before_sidebar_hydration(self):
        ...
        self.assertLess(app_text.index('if _sidebar_panel_toggle("Advanced Scope", "advanced_scope")'), app_text.index('"Triage Mode"'))
        self.assertLess(app_text.index('"Triage Mode"'), app_text.index('if _sidebar_panel_toggle("Saved Views", "saved_views")'))
