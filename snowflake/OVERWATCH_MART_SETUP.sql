...
BEGIN
  ...
  WITH action_queue AS (
    SELECT
      ...
      COALESCE(TRY_TO_NUMBER(EST_MONTHLY_SAVINGS), 0) AS EXPECTED_SAVINGS_USD,
      IFF(UPPER(COALESCE(VERIFICATION_STATUS, '')) = 'VERIFIED' AND MEASURED_DELTA IS NOT NULL, GREATEST(TRY_TO_NUMBER(MEASURED_DELTA), 0), 0) AS ACTUAL_VERIFIED_SAVINGS_USD,
