...
DBA_CONTROL_PLANE_SECTION_BASELINE = {
    "DBA Control Room": {
        ...
        "data_correctness": 90,
        "actionability": 95,
        "admin_safety_audit": 91,
        "performance_mart": 90,
        "workflow_ux": 92,
        "governance_ownership": 91,
        "tests_operability": 94,
    },
    "Alert Center": {
        "domain_coverage": 94,
        "data_correctness": 95,
    ...
    "Change & Drift": {
        ...
        "data_correctness": 90,
        "actionability": 94,
        "admin_safety_audit": 92,
        "performance_mart": 87,
        "workflow_ux": 91,
        "governance_ownership": 92,
        "tests_operability": 94,
    },
    "Account Health": {
        "domain_coverage": 92,
...
DBA_CONTROL_PLANE_SECTION_NEXT_MOVES = {
    "DBA Control Room": "Connect closure blockers to live ITSM ticket state, execution audit writes, and named ALFA owner groups.",
    ...
    "Warehouse Health": "Connect ownership readiness to executed rollback/savings verification evidence and persisted warehouse settings change audit.",
    ...
    "Security Posture": "Connect privileged grant readiness to live IAM/ITSM approvals and automate closure from verified Snowflake evidence.",
    "Change & Drift": "Ingest live change tickets/source-control state and automate approval/closure evidence from ITSM and deployment systems.",
    "Account Health": "Connect account-hygiene and checklist route readiness to live ITSM ticket state and auto-close verified evidence-backed actions.",
}
