...
BEGIN
 ...
 AND cur.WINDOW_DAYS = next.WINDOW_DAYS
  ...
  WHEN NOT MATCHED THEN INSERT (
    ...
    next.SECTION_NAME, next.COMPANY, next.ENVIRONMENT, next.WINDOW_DAYS, next.BRIEF_ID, next.DECISION_PACKET,
...
FROM (
  ...
  FROM VALUES
    ...
    ('GENERATED_WINDOW_COUNT'), ('GENERATED_SCOPE_COUNT'), ('ERROR_MESSAGE'), ('LOAD_TS')
) required_columns
LEFT JOIN INFORMATION_SCHEMA.COLUMNS c
  ON UPPER(c.TABLE_SCHEMA) = UPPER(CURRENT_SCHEMA())
