...
def _fixture_brief(
    ...
    *,
    ...
    fixture_metrics = {
        "Executive Landing": (
            _fixture_metric("total_spend", "Total Spend", "$42.8K", numeric=42800, fmt="currency", detail="vs prior 7d ↑ 18.2%", tone="risk", sort=10),
            _fixture_metric("critical_high_issues", "Critical / High Alerts", "7", numeric=7, fmt="integer", detail="vs prior 7d ↑ 2", tone="risk", sort=20),
            _fixture_metric("open_actions", "Open Actions", "23", numeric=23, fmt="integer", detail="vs prior 7d ↓ 4", tone="improvement", sort=30),
            _fixture_metric("cortex_spend", "Cortex AI Spend", "$6.4K", numeric=6400, fmt="currency", detail="31% of total spend", tone="cortex", sort=40),
            _fixture_metric("failed_queries", "Failed Queries", "182", numeric=182, fmt="integer", detail="vs prior 7d ↓ 34", tone="improvement", sort=50),
        ),
        "Cost & Contract": (
    ...
    signal = exceptions[0]
    actions = _default_actions(contract)
    if section == "Executive Landing":
        actions = (
