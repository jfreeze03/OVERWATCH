...
class PerformanceFrameworkTests(unittest.TestCase):
    ...
    def test_section_smoke_runner_is_optional_navigation_coverage(self):
        ...
        self.assertIn("OPTIMIZATION", runner_text)
        self.assertIn("COMMAND CENTER", runner.DEFAULT_SECTIONS)
        ...
        self.assertIn("SECTION_READY_TEXT", runner_text)
        self.assertIn('page.get_by_text("OVERWATCH COMMAND CENTER"', runner_text)
    ...
    def test_live_concurrent_runner_uses_only_safe_load_buttons(self):
        ...
        self.assertEqual(runner.DEFAULT_LOAD_BUTTONS, {})
        self.assertIn("COMMAND CENTER", readme)
        self.assertIn("does not click load/detail actions by default", readme)
    ...
    def test_live_concurrent_runner_summarizes_browser_steps(self):
        ...
        samples = [
            ...
            runner.StepSample(1, 1, "Cost & Contract", "load_button:Refresh Cost", 3000.0, True),
            runner.StepSample(2, 1, "Cost & Contract", "load_button:Refresh Cost", 5000.0, False, "boom"),
        ...
        self.assertIn("load_button:Refresh Cost", summary["by_action"])
        self.assertIn(summary["readiness_state"], {"PASS", "WATCH"})
