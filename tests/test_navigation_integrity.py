...
class NavigationIntegrityTests(unittest.TestCase):
    ...
    def test_sidebar_navigation_requests_section_detail_state(self):
        ...
        self.assertIn('st.session_state["workload_operations_query_focus"] = "AI Query Diagnosis"', app_text)
        ...
        self.assertIn('st.session_state["workload_operations_query_focus"] = "AI Query Diagnosis"', navigation_text)
