...
class DecisionWorkspaceDataBindingTests(unittest.TestCase):
    ...
    def test_targeted_evidence_loaders_push_filters_before_rows(self):
        ...
        self.assertIn('build_target_predicate_plan("Alert Center"', alert_query)
        self.assertIn("evidence_target_label", alert_query)
        self.assertIn("target_predicate_plan_id", alert_query)
        self.assertIn("def load_cost_evidence(", cost_evidence)
        self.assertIn("build_target_sql_filter(", cost_evidence)
        self.assertIn("build_target_predicate_plan(", cost_evidence)
        self.assertIn("target_predicate_plan_id", cost_evidence)
