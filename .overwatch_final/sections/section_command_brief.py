...
SELECT
    ...
    COALESCE(
        DECISION_PACKET:"AVAILABLE_REQUIRED_SOURCE_COUNT"::NUMBER,
        DECISION_PACKET:"AVAILABLE_SOURCE_COUNT"::NUMBER
    ) AS AVAILABLE_SOURCE_COUNT,
    COALESCE(
        DECISION_PACKET:"REQUIRED_MISSING_SOURCE_COUNT"::NUMBER,
        DECISION_PACKET:"MISSING_SOURCE_COUNT"::NUMBER
