...
DBA_CONTROL_PLANE_SECTION_BASELINE = {
    "DBA Control Room": {
        ...
        "data_correctness": 88,
        "actionability": 92,
        "admin_safety_audit": 84,
        "performance_mart": 90,
        "workflow_ux": 89,
        "governance_ownership": 83,
    ...
    "Security Posture": {
        ...
        "performance_mart": 80,
        "workflow_ux": 84,
        "governance_ownership": 82,
        "tests_operability": 88,
    },
    "Change & Drift": {
        "domain_coverage": 87,
        "data_correctness": 84,
...
DBA_CONTROL_PLANE_SECTION_NEXT_MOVES = {
    "DBA Control Room": "Add live change-ticket integration, execution audit writes, and CMDB/on-call owner enrichment.",
    "Alert Center": "Add approved Snowflake email integration, owner on-call mapping, and delivery evidence replay.",
    "Workload Operations": "Add owner/on-call enrichment beyond free-text roles and approved recovery execution audit.",
    "Warehouse Health": "Replace static owner hints with live warehouse-owner tags, approval closure, rollback execution evidence, and verified savings trends.",
    "Cost & Contract": "Add CMDB/on-call owner enrichment so cost findings route to real named accountable owners.",
    "Security Posture": "Replace inferred owner/approval routing with live IAM/access-owner inventory, ticket integration, and automated closure evidence.",
    "Change & Drift": "Replace ticket/IaC hints with live change-ticket ingestion, source-control comparison, and approval closure automation.",
    "Account Health": "Replace static owner hints with live service/on-call owner integration and automated closure execution from verification outcomes.",
}
