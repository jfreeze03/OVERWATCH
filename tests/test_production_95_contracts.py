...
class Production95ContractsTests(unittest.TestCase):
    ...
    def test_executive_landing_is_kpi_first_not_shell_brief(self):
        ...
        self.assertIn("Next best actions", executive_overview)
        self.assertNotIn("Refresh Board", executive_shell)
        self.assertNotIn("Executive Command Wall", executive_shell)
        self.assertNotIn("Setup Readiness", executive_shell)
        self.assertNotIn("Platform Operating Score", executive_shell)
        self.assertNotIn("Platform Score Basis", executive_shell)
        self.assertNotIn("Platform Score Drivers", executive_shell)
        self.assertNotIn("render_native_readiness_board", executive_shell)
        self.assertNotIn("from sections.native_readiness import render_native_readiness_board", executive_shell)
        self.assertNotIn("from sections.native_readiness", executive_shell)
