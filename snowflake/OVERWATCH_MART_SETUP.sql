...
SELECT
  'SECTION_DECISION_CURRENT_FLAT_VIEW' AS CHECK_NAME,
  COUNT(*) AS MISSING_VIEW,
  IFF(COUNT(*) = 0, 'PASS', 'FAIL') AS STATUS
FROM (
  SELECT 'MART_SECTION_DECISION_CURRENT_FLAT' AS VIEW_NAME
) required_view
LEFT JOIN INFORMATION_SCHEMA.VIEWS v
  ON UPPER(v.TABLE_SCHEMA) = UPPER(CURRENT_SCHEMA())
 AND UPPER(v.TABLE_NAME) = required_view.VIEW_NAME
