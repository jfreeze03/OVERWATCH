...
class NavigationIntegrityTests(unittest.TestCase):
    ...
    def test_priority_tables_defer_full_raw_detail_rendering(self):
        ...
        self.assertIn('("DATABASE_NAME", "SCHEMA_NAME")', workflows_text)
        self.assertIn("def _prioritize_context_columns", display_text)
        self.assertIn("grid_df = _prioritize_context_columns(df.head(1000))", display_text)
