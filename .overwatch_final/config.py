...
ARCHITECTURE_OBJECTIVES = (
    ...
    },
    {
        ...
        "RPO_MINUTES": 720,
        "RTO_MINUTES": 1440,
        "ISOLATION_POLICY": "SIT can share approved test compute but production-release testing should have a named route.",
        "CACHE_POLICY": "Review cache only for repeat test-cycle workloads that affect release validation.",
        "CLUSTERING_POLICY": "Keep clustering aligned with production-like test predicates and approved cost posture.",
...
FORWARD_PLATFORM_CONTROLS = (
    ...
    },
    {
        ...
        "RISK_IF_MISSING": "Agent or analyst answers can look authoritative while using unowned or untested semantic definitions.",
        "DBA_DECISION": "Require owner, certified model, test query set, freshness proof, and regression checks before trusted use.",
