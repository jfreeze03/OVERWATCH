...
_DISPLAY_TEXT_REPLACEMENTS = (
    ...
    (r"\bTelemetry Status\b", "Telemetry Status"),
    (r"\bStatus Note\b", "Status Note"),
    (r"\bStatus By\b", "Status By"),
    (r"\bStatus At\b", "Status At"),
    (r"\bTelemetry Status\b", "Status"),
    ...
    (r"\bReview Status Ready\b", "Route Ready"),
    ...
    (r"\bgovernance\b", "monitoring"),
    (r"\bEscalation Route\b", "Escalation Route"),
    (r"\bWorkflow route\b", "Escalation route"),
    (r"\bworkflow route\b", "escalation route"),
    (r"\bAllocation Source\b", "Route Basis"),
    (r"\bAllocation Basis\b", "Route Basis"),
...
def clean_operator_display_text(df):
    ...
    frame = frame.rename(columns={
        ...
        "ALLOCATION_SOURCE": "ROUTE_BASIS",
        "ALLOCATION_BASIS": "ALLOCATION_BASIS",
        "Owner": "Route",
        "Email Target": "Email Target",
        "Allocation Source": "Route Basis",
        "Allocation Basis": "Route Basis",
        ...
        "REVIEW_STATUS": "TELEMETRY_STATUS",
        "REVIEW_STATE": "TELEMETRY_STATE",
        "REVIEW_NOTE": "STATUS_NOTE",
        "REVIEWED_BY": "STATUS_BY",
        "REVIEWED_AT": "STATUS_AT",
        "REVIEW_GAP_ROWS": "TELEMETRY_GAP_ROWS",
        "Telemetry Status": "Telemetry Status",
        "Telemetry State": "Telemetry State",
        "Status Note": "Status Note",
        "Status By": "Status By",
        "Status At": "Status At",
        "Telemetry Gap Rows": "Telemetry Gap Rows",
        ...
        "REVIEW_STATUS_READY": "ROUTE_READY",
        ...
        "APPROVER": "REVIEWER",
        "Approver": "Reviewer",
        "WORKFLOW_GAP_ROWS": "ROUTE_GAP_ROWS",
        "Workflow Gap Rows": "Route Gap Rows",
...
def _operator_status_label(value, column: str = ""):
    ...
    if text == "Pending":
        ...
        if "APPROVAL" in column_upper or "REVIEW" in column_upper:
...
def render_priority_dataframe(
    ...
    *,
    ...
    hidden_ui_columns = {
        ...
        "REVIEWED_AT",
        "Status At",
        "WORKFLOW_ROUTE_READY",
        "Escalation Route Ready",
        "WORKFLOW_ROUTE_STATE",
        "Escalation Route State",
        "ALLOCATION_SOURCE",
        "Allocation Source",
        "ALLOCATION_BASIS",
        "Allocation Basis",
