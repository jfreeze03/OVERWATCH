...
class NavigationIntegrityTests(unittest.TestCase):
    ...
    def test_fast_shells_offer_back_to_brief_toggle(self):
        ...
        for section, module_path in shell_modules.items():
            with self.subTest(section=section):
                ...
                self.assertIn("render_shell_snapshot(metrics)", shell_text)
    ...
    def test_app_shell_header_renders_before_sidebar_hydration(self):
        ...
        self.assertLess(app_text.index('if _sidebar_panel_toggle("Advanced Scope", "advanced_scope")'), app_text.index('"Exceptions-only mode"'))
    ...
    def test_app_performance_hot_paths_are_deferred_or_cached(self):
        ...
        self.assertNotIn("📋 Preview & Apply Changes", dba_tools_text)
        self.assertNotIn("📥 Download SQL", dba_tools_text)
        self.assertNotIn("📋 Cortex access control SQL snippets", dba_tools_text)
        self.assertNotIn("🟡", dba_tools_text)
        self.assertNotIn("🔴", dba_tools_text)
        self.assertNotIn("↳", dba_tools_text)
