...
COMMAND_BOARD_VERSION = "2026-07-06-compact-mart-only"
...
def empty_command_board(
    ...
    *,
    ...
    """Return an immediate mart-not-ready monitoring summary frame for first paint."""
...
def load_or_reuse_command_board(
    *,
    ...
    """Return the shared monitoring summary from compact marts only."""
    ...
    if not payload.summary.get("loaded"):
        payload = empty_command_board(company, environment, days, state="Refresh required")
