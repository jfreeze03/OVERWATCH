...
USING (
  SELECT
    ...
    DECISION_PACKET:"ACCOUNT_BILLED_CREDITS"::NUMBER AS ACCOUNT_BILLED_CREDITS,
    DECISION_PACKET:"ACCOUNT_BILLED_COST_USD"::NUMBER AS ACCOUNT_BILLED_COST_USD,
    DECISION_PACKET:"ACCOUNT_USED_CREDITS"::NUMBER AS ACCOUNT_USED_CREDITS,
    DECISION_PACKET:"COMPUTE_CREDITS"::NUMBER AS COMPUTE_CREDITS,
    DECISION_PACKET:"CLOUD_SERVICES_CREDITS"::NUMBER AS CLOUD_SERVICES_CREDITS,
    DECISION_PACKET:"CLOUD_SERVICES_ADJUSTMENT"::NUMBER AS CLOUD_SERVICES_ADJUSTMENT,
    DECISION_PACKET:"ACCOUNT_CLOUD_SERVICES_ADJUSTMENT"::NUMBER AS ACCOUNT_CLOUD_SERVICES_ADJUSTMENT,
    DECISION_PACKET:"WAREHOUSE_CREDITS"::NUMBER AS WAREHOUSE_CREDITS,
    DECISION_PACKET:"WAREHOUSE_COST_ESTIMATE_USD"::NUMBER AS WAREHOUSE_COST_ESTIMATE_USD,
    DECISION_PACKET:"WAREHOUSE_COST_USD"::NUMBER AS WAREHOUSE_COST_USD,
    DECISION_PACKET:"SERVICE_OTHER_CREDITS"::NUMBER AS SERVICE_OTHER_CREDITS,
    DECISION_PACKET:"SERVICE_OTHER_COST_USD"::NUMBER AS SERVICE_OTHER_COST_USD,
    DECISION_PACKET:"BILLING_BRIDGE_DELTA_CREDITS"::NUMBER AS BILLING_BRIDGE_DELTA_CREDITS,
    DECISION_PACKET:"BILLING_BRIDGE_DELTA_USD"::NUMBER AS BILLING_BRIDGE_DELTA_USD,
    DECISION_PACKET:"BILLING_BRIDGE_STATUS"::VARCHAR AS BILLING_BRIDGE_STATUS,
    DECISION_PACKET:"CORTEX_AI_CREDITS"::NUMBER AS CORTEX_AI_CREDITS,
    DECISION_PACKET:"CORTEX_AI_COST_USD"::NUMBER AS CORTEX_AI_COST_USD,
    ...
    DECISION_PACKET:"SPEND_MOVEMENT_PCT"::NUMBER AS SPEND_MOVEMENT_PCT,
    DECISION_PACKET:"FORECAST_RUN_RATE_USD"::NUMBER AS FORECAST_RUN_RATE_USD,
