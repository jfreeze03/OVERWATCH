...
WITH expected_metrics AS (
  SELECT * FROM VALUES
    ...
    ('DBA Control Room', 'failed_queries', TRUE, 'dba_control_room', 'required'),
    ('DBA Control Room', 'pipeline_failures', TRUE, 'dba_control_room', 'required'),
    ('DBA Control Room', 'queue_pressure', TRUE, 'action_queue', 'required'),
    ('DBA Control Room', 'cost_24h', TRUE, 'cost_summary', 'required'),
    ('DBA Control Room', 'cortex_cost', FALSE, 'dba_control_room', 'optional'),
    ('DBA Control Room', 'security_warnings', FALSE, 'security_summary', 'optional'),
    ('DBA Control Room', 'recent_changes', FALSE, 'dba_control_room', 'optional'),
    ('DBA Control Room', 'overdue_actions', FALSE, 'dba_control_room', 'optional'),
    ...
    ('Security Monitoring', 'failed_logins', TRUE, 'security_operability', 'required'),
    ('Security Monitoring', 'mfa_gaps', TRUE, 'security_operability', 'required'),
    ('Security Monitoring', 'risky_grants', TRUE, 'security_operability', 'required'),
