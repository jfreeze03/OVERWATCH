...
BEGIN
 ...
 AND cur.WINDOW_DAYS = next.WINDOW_DAYS
  ...
  SELECT
    ...
    ENVIRONMENT,
    WINDOW_DAYS,
    COALESCE(DECISION_PACKET:"SNAPSHOT_TS"::TIMESTAMP_NTZ, SNAPSHOT_TS),
    DECISION_PACKET:"STATE"::VARCHAR,
    DECISION_PACKET:"HEADLINE"::VARCHAR,
    DECISION_PACKET:"SUMMARY"::VARCHAR,
    DECISION_PACKET:"TOP_SIGNAL"::VARCHAR,
    DECISION_PACKET:"TOP_ENTITY"::VARCHAR,
    DECISION_PACKET:"TOP_ACTION"::VARCHAR,
    DECISION_PACKET:"SOURCE_STATUS"::VARCHAR,
    DECISION_PACKET:"SOURCE_FRESHNESS"::VARCHAR,
    DECISION_PACKET:"SOURCE_OBJECTS"::VARCHAR,
    COALESCE(DECISION_PACKET:"SOURCE_SNAPSHOT_TS"::TIMESTAMP_NTZ, SOURCE_SNAPSHOT_TS),
    COALESCE(DECISION_PACKET:"FRESHNESS_MINUTES"::NUMBER, FRESHNESS_MINUTES),
    DECISION_PACKET:"TARGET_FRESHNESS_MINUTES"::NUMBER,
    DECISION_PACKET:"IS_STALE"::BOOLEAN,
    DECISION_PACKET:"RESOLVED_COMPANY"::VARCHAR,
    DECISION_PACKET:"RESOLVED_ENVIRONMENT"::VARCHAR,
    DECISION_PACKET:"RESOLVED_WINDOW_DAYS"::NUMBER,
    DECISION_PACKET:"CONFIDENCE"::VARCHAR,
    DECISION_PACKET:"REQUIRED_SOURCE_COUNT"::NUMBER,
    COALESCE(DECISION_PACKET:"AVAILABLE_REQUIRED_SOURCE_COUNT"::NUMBER, DECISION_PACKET:"AVAILABLE_SOURCE_COUNT"::NUMBER),
    COALESCE(DECISION_PACKET:"REQUIRED_MISSING_SOURCE_COUNT"::NUMBER, DECISION_PACKET:"MISSING_SOURCE_COUNT"::NUMBER),
    DECISION_PACKET:"AVAILABLE_REQUIRED_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"REQUIRED_MISSING_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"REQUIRED_STALE_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"OPTIONAL_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"AVAILABLE_OPTIONAL_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"OPTIONAL_MISSING_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"OPTIONAL_STALE_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"SOURCE_COVERAGE_PCT"::NUMBER,
    DECISION_PACKET:"DATA_AVAILABILITY_STATE"::VARCHAR,
    DECISION_PACKET:"STALE_SOURCE_COUNT"::NUMBER,
    DECISION_PACKET:"SOURCE_GAP_DETAIL"::VARCHAR,
    DECISION_PACKET:"PRIMARY_ACTION_KEY"::VARCHAR,
    DECISION_PACKET:"PRIMARY_ROUTE_KEY"::VARCHAR,
    DECISION_PACKET:"PRIMARY_ACTION_LABEL"::VARCHAR,
    DECISION_PACKET:"PRIMARY_ACTION_DETAIL"::VARCHAR,
    COALESCE(DECISION_PACKET:"LOAD_TS"::TIMESTAMP_NTZ, LOAD_TS),
    DECISION_PACKET:"METRICS",
    DECISION_PACKET:"EXCEPTIONS",
    DECISION_PACKET:"ACTIONS",
    DECISION_PACKET:"SOURCES",
    LENGTH(TO_JSON(DECISION_PACKET)),
    TRUE
  FROM TMP_SECTION_DECISION_PACKET;
