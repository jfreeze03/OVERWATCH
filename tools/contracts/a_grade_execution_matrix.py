...
def build_a_grade_execution_matrix(
    ...
    *,
    ...
    gate_specs = [
        ...
        (
            "Query and app performance",
            "P0 Account Usage audit",
            "no default Account Usage paths",
            "B+",
            "A",
            "Account Usage allowed only in setup, live validation, admin, or explicit deep-evidence boundaries",
            "tests.test_account_usage_query_audit",
            "account_usage_query_audit_results.json",
            "source-level producer audit",
            "artifacts/launch_readiness/account_usage_query_audit_gate_results.json",
            True,
        ),
        (
            "Query and app performance",
            "P0 summary mart setup",
            "compact summary marts",
            "B+",
            "A",
            "section-summary autoload reads compact marts or packets instead of raw Account Usage",
            "tests.test_summary_mart_setup",
            "summary_mart_setup_results.json",
            "setup SQL object and column proof",
        ...
        (
            "Production launch readiness",
            "P0 artifact reality",
            "shared artifact integrity verifier",
            "A-",
            "A",
            "exact file parse, commit/provenance/hash checks, no boolean-only proof",
            "tests.test_artifact_verifier; tests.test_launch_readiness; tests.test_production_release_candidate",
            "artifact_integrity_results.json; artifact_integrity_gate_results.json",
            "producer-backed artifact verifier rows and release hash manifest",
            "artifacts/launch_readiness/artifact_integrity_gate_results.json",
            True,
        ),
        (
        ...
        (
            "Query and app performance",
            "P0 source runtime event ledger",
            "app-source query/session boundary telemetry",
            "B+",
            "A",
            "runtime_state source events materialized and launch-gated with approved execution boundaries",
            "tests.test_runtime_event_ledger",
            "source_runtime_event_ledger_results.json; source_runtime_event_ledger_gate_results.json",
            "producer-backed source runtime rows",
