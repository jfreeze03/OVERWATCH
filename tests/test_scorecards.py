...
class ScorecardTests(unittest.TestCase):
    ...
    def test_dba_section_baseline_is_strict_and_repeatable(self):
        ...
        self.assertEqual(by_section["Alert Center"]["SCORE"], 95.5)
        ...
        self.assertEqual(by_section["Workload Operations"]["SCORE"], 95.8)
        self.assertEqual(by_section["Workload Operations"]["LABEL"], "95 Target")
        self.assertEqual(by_section["Cost & Contract"]["SCORE"], 96.5)
        self.assertEqual(by_section["Cost & Contract"]["LABEL"], "95 Target")
        self.assertEqual(by_section["Security Posture"]["SCORE"], 95.5)
