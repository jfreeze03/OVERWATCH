...
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS OWNER_EMAIL VARCHAR(500);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS ONCALL_PRIMARY VARCHAR(200);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS ONCALL_SECONDARY VARCHAR(200);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS APPROVAL_GROUP VARCHAR(200);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS ESCALATION_TARGET VARCHAR(200);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS OWNER_SOURCE VARCHAR(200);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS OWNER_EVIDENCE VARCHAR(2000);
ALTER TABLE OVERWATCH_ACTION_QUEUE ADD COLUMN IF NOT EXISTS RECOVERY_AUDIT_STATE VARCHAR(100);
...
ALTER TABLE OVERWATCH_CHANGE_CONTROL_EVIDENCE ADD COLUMN IF NOT EXISTS APPROVAL_ROUTE_READY VARCHAR(20);
ALTER TABLE OVERWATCH_CHANGE_CONTROL_EVIDENCE ADD COLUMN IF NOT EXISTS CHANGE_EVIDENCE_READINESS VARCHAR(80);
ALTER TABLE OVERWATCH_CHANGE_CONTROL_EVIDENCE ADD COLUMN IF NOT EXISTS EVIDENCE_BLOCKERS VARCHAR(2000);
ALTER TABLE OVERWATCH_CHANGE_CONTROL_EVIDENCE ADD COLUMN IF NOT EXISTS REVIEW_SLA_HOURS NUMBER;
ALTER TABLE OVERWATCH_CHANGE_CONTROL_EVIDENCE ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
...
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS ACCESS_TICKET_ID VARCHAR(200);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS REVIEW_BY_DATE VARCHAR(100);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS IAM_APPROVAL_STATE VARCHAR(120);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS REVIEW_READINESS VARCHAR(100);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS REVIEW_BLOCKERS VARCHAR(2000);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS REVIEW_SLA_HOURS NUMBER;
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS VERIFICATION_STATUS VARCHAR(80);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS VERIFICATION_RESULT VARCHAR(4000);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS CONTROL_READINESS VARCHAR(100);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS CONTROL_BLOCKERS VARCHAR(2000);
ALTER TABLE OVERWATCH_SECURITY_ACCESS_REVIEW ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
...
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_SOURCE VARCHAR(80);
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS SIGNAL VARCHAR(120);
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_STATE VARCHAR(120);
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_RANK NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CAPACITY_SCORE FLOAT;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS QUERY_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS QUEUE_PRESSURE_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS SPILL_PRESSURE_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS HIGH_LATENCY_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CREDIT_ALLOCATION_METHOD VARCHAR(160);
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS REVIEW_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS OWNER_APPROVAL_GAP_ROWS NUMBER;
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
ALTER TABLE FACT_WAREHOUSE_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS LAST_ACTIVITY_TS TIMESTAMP_NTZ;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_SOURCE VARCHAR(80);
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_STATE VARCHAR(120);
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_RANK NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS EVENT_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS REVIEW_BLOCKER_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS TICKET_REQUIRED_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS REVIEW_BY_REQUIRED_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CAPABILITY_PROOF_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS NO_DATABASE_CONTEXT_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS OWNER_APPROVAL_GAP_ROWS NUMBER;
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
ALTER TABLE FACT_SECURITY_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS LAST_ACTIVITY_TS TIMESTAMP_NTZ;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_SOURCE VARCHAR(80);
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_STATE VARCHAR(120);
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_RANK NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS HEALTH_SCORE FLOAT;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS ISSUE_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS ROUTE_BLOCKER_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS QUEUE_REQUIRED_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS ACCESS_HYGIENE_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS FAILED_LOGIN_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS PRIVILEGED_GRANT_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS OWNER_APPROVAL_GAP_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS RECOVERY_RISK_ROWS NUMBER;
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
ALTER TABLE FACT_ACCOUNT_HEALTH_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS LAST_ACTIVITY_TS TIMESTAMP_NTZ;
...
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_SOURCE VARCHAR(80);
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_KEY VARCHAR(500);
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS HIGH_RISK_CHANGES NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS ROUTE_BLOCKED NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CLOSURE_BLOCKED NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS REVIEW_READY NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS OWNER_APPROVAL_GAP_ROWS NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_STATE VARCHAR(120);
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS CONTROL_RANK NUMBER;
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS NEXT_CONTROL_ACTION VARCHAR(4000);
ALTER TABLE FACT_CHANGE_CONTROL_OPERABILITY_DAILY ADD COLUMN IF NOT EXISTS LAST_ACTIVITY_TS TIMESTAMP_NTZ;
