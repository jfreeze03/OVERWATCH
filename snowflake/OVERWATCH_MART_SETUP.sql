...
BEGIN
  ...
  facts AS (
    ...
    WHERE s.ENVIRONMENT = 'ALL'
       OR sc.SECTION_NAME IN ('Alert Center', 'Workload Operations')
  )
  SELECT
  ...
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         ...
         cfg.DEFAULT_CONFIDENCE AS CONFIDENCE, :snapshot_ts AS SNAPSHOT_TS
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.EXECUTIVE_SCORECARD_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.FORECAST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CLOSED_LOOP_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.PRODUCTION_READINESS_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.DATA_TRUST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.APP_OBSERVABILITY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CONTROL_ROOM_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COST_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CORTEX_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COST_SIGNAL_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.VALUE_LEDGER_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.SETTINGS_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.QUERY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.QUERY_DETAIL_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.TASK_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.PROCEDURE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.COPY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ALERT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.NOTIFICATION_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ACKNOWLEDGEMENT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.ACTION_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.SECURITY_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.LOGIN_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.GRANT_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.OWNER_COVERAGE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
  ...
  UNION ALL
  SELECT f.BRIEF_ID, f.SECTION_NAME, f.COMPANY, f.ENVIRONMENT, f.WINDOW_DAYS, cfg.SOURCE_KEY, cfg.SOURCE_OBJECT,
         cfg.REQUIRED, f.CHANGE_SOURCE_TS, cfg.TARGET_FRESHNESS_MINUTES, cfg.DEFAULT_CONFIDENCE, :snapshot_ts
  FROM TMP_SECTION_COMMAND_FACTS f
 ...
 AND cur.WINDOW_DAYS = next.WINDOW_DAYS
  ...
  INSERT INTO OVERWATCH_DECISION_REFRESH_AUDIT (
    ...
    FAILED_SECTION_COUNT, ERROR_MESSAGE, LOAD_TS
  )
  SELECT
    UUID_STRING(),
    CURRENT_TIMESTAMP(),
...
BEGIN
  ...
  INSERT INTO OVERWATCH_LOAD_AUDIT (LOAD_NAME, LOAD_STARTED_AT, LOAD_FINISHED_AT, STATUS, ROWS_LOADED, MESSAGE)
  SELECT 'SP_OVERWATCH_REFRESH_DECISION_BRIEFS_FAST',
         CURRENT_TIMESTAMP(),
         CURRENT_TIMESTAMP(),
         'SUCCESS',
         COUNT(*),
         'FAST refresh retained current 1-day and 7-day operational Decision packets.'
  FROM MART_SECTION_DECISION_CURRENT
  WHERE WINDOW_DAYS IN (1, 7);
...
BEGIN
  ...
  INSERT INTO OVERWATCH_LOAD_AUDIT (LOAD_NAME, LOAD_STARTED_AT, LOAD_FINISHED_AT, STATUS, ROWS_LOADED, MESSAGE)
  SELECT 'SP_OVERWATCH_REFRESH_DECISION_BRIEFS_FULL',
         CURRENT_TIMESTAMP(),
         CURRENT_TIMESTAMP(),
         'SUCCESS',
         COUNT(*),
         'FULL refresh retained all generated Decision packet windows for enrichment and history.'
  FROM MART_SECTION_DECISION_CURRENT;
...
FROM (
  ...
  FROM VALUES
    ...
    ('DEGRADED_COUNT'), ('FAILED_SECTION_COUNT'), ('ERROR_MESSAGE'), ('LOAD_TS')
) required_columns
LEFT JOIN INFORMATION_SCHEMA.COLUMNS c
  ON UPPER(c.TABLE_SCHEMA) = UPPER(CURRENT_SCHEMA())
