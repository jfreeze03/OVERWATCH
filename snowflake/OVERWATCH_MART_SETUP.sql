...
BEGIN
  ...
  INSERT INTO FACT_QUERY_HOURLY (
    ...
    SCHEMA_NAME, QUERY_TYPE, QUERY_COUNT, FAILED_COUNT, AVG_EXECUTION_MS,
  ...
  INSERT INTO DIM_TASK_SNAPSHOT (
    SNAPSHOT_TS, COMPANY, DATABASE_NAME, SCHEMA_NAME, TASK_NAME,
  ...
  INSERT INTO DIM_PROCEDURE_SNAPSHOT (
    SNAPSHOT_TS, COMPANY, DATABASE_NAME, SCHEMA_NAME, PROCEDURE_NAME,
  ...
  INSERT INTO FACT_OBJECT_CHANGE (
    ...
    SCHEMA_NAME, CHANGE_CATEGORY, QUERY_TYPE, QUERY_TAG, QUERY_TEXT
  )
  SELECT
    START_TIME,
    CASE
  ...
  BEGIN
    ...
    INSERT INTO FACT_TASK_RUN (
      SCHEDULED_TIME, COMPLETED_TIME, COMPANY, DATABASE_NAME, SCHEMA_NAME,
  ...
  INSERT INTO FACT_PROCEDURE_RUN (
    START_TIME, COMPANY, PROCEDURE_NAME, CALL_QUERY_ID, ROOT_QUERY_ID,
...
BEGIN
  ...
  INSERT INTO FACT_STORAGE_DAILY (
    SNAPSHOT_DATE, COMPANY, DATABASE_NAME, ACTIVE_BYTES, TIME_TRAVEL_BYTES,
  ...
  INSERT INTO DIM_TABLE_SNAPSHOT (
    SNAPSHOT_TS, COMPANY, DATABASE_NAME, SCHEMA_NAME, TABLE_NAME, TABLE_TYPE,
  ...
  INSERT INTO FACT_COPY_LOAD_DAILY (
    LOAD_DATE, COMPANY, DATABASE_NAME, SCHEMA_NAME, TABLE_NAME, STATUS,
