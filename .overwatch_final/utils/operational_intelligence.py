...
def build_capability_register_rows() -> list[dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "WHY_IT_MATTERS": "Forecasts burn, ranks cost drivers, and keeps operators out of raw ACCOUNT_USAGE scans.",
        ...
        },
        {
            ...
            "WHY_IT_MATTERS": "If the business runs multiple Snowflake accounts, cost/risk must roll up above one account.",
