...
BEGIN
  ...
  FROM (
    ...
    FROM TMP_SECTION_COMMAND_FACTS WHERE SECTION_NAME IN ('Executive Landing', 'Cost & Contract', 'DBA Control Room')
    UNION ALL
    ...
    FROM TMP_SECTION_COMMAND_FACTS WHERE SECTION_NAME IN ('Executive Landing', 'Alert Center', 'Security Monitoring')
    UNION ALL
    ...
    FROM TMP_SECTION_COMMAND_FACTS WHERE SECTION_NAME IN ('Executive Landing', 'Alert Center', 'Cost & Contract')
    UNION ALL
