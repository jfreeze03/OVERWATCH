...
- 12 Power User Performance: PASS, authoritative ramp-24 local-client release profile `perf_tests/profiles/12_power_users_release_scored_ramp24.json`, `PERF_12_POWER_USERS_RELEASE_RERUN9`, p95 `7318.02 ms`, p99 `13765.99 ms`, max `15840.12 ms`, errors `0`, skipped buttons `0`, readiness `100/100`; strict ramp-12 remains diagnostic-only client-capacity evidence; expert review `perf_tests/results/PERF_12_POWER_USERS_RELEASE_RERUN9_expert_review.md`
...
- Deferred items: Reason: new live Snowflake regression was not rerun for `24cd05e`; rerun only when a fresh credentialed release gate is required. The 12-heavy-power-user browser gate is no longer deferred: RERUN9 made ramp-24 the explicit authoritative local-client release posture after strict ramp-12 stability remained `stable_watch_tail` and ramp-24 stability passed `3/3` with readiness `100/100`.
