...
register_query_contract(
    QueryContract(
        ...
        expected_table_family=(
            ...
            "V_EXECUTIVE_PACKET_CURRENT|V_QUERY_DAILY_SUMMARY|V_WAREHOUSE_DAILY_CREDITS|"
            "V_CORTEX_DAILY_USAGE|V_LOGIN_SECURITY_DAILY|V_TASK_STATUS_DAILY|"
            "V_LEADERSHIP_|"
            "V_SECURITY_POSTURE_DAILY|OVERWATCH_EXECUTIVE_PACKET_CURRENT|OVERWATCH_COST_CURRENT_SUMMARY|"
