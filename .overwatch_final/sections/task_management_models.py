...
def _build_task_recovery_sla_frame(
    ...
    for task_name, group in hist.sort_values("EVENT_TIME").groupby("TASK_NAME", dropna=False):
        ...
        row = {
            ...
            "EMAIL_TARGET": owner_context.get("EMAIL_TARGET", ""),
            "REVIEWED_BY": owner_context.get("REVIEWED_BY", ""),
            "REVIEWED_BY": owner_context.get("REVIEWED_BY", ""),
            "REVIEW_STATUS": owner_context.get("REVIEW_STATUS", ""),
            "WORKFLOW_ROUTE": owner_context.get("WORKFLOW_ROUTE", ""),
            "ALLOCATION_SOURCE": owner_context.get("ALLOCATION_SOURCE", ""),
            "ALLOCATION_BASIS": owner_context.get("ALLOCATION_BASIS", ""),
