...
class GuardrailTests(unittest.TestCase):
    ...
    def test_usage_overview_and_heatmap_sources_use_mart_before_live(self):
        ...
        self.assertIn("BUILD_MART_USAGE_OVERVIEW_SQL", shared_metrics_text)
        self.assertIn("BUILD_MART_USAGE_PRESSURE_SQL", shared_metrics_text)
        self.assertIn("BUILD_MART_WAREHOUSE_OVERVIEW_SQL", shared_metrics_text)
        self.assertIn("BUILD_MART_WAREHOUSE_SCALING_SQL", shared_metrics_text)
        self.assertIn("BUILD_MART_WAREHOUSE_HEATMAP_SQL", shared_metrics_text)
        self.assertIn("LOAD_SHARED_MFA_COVERAGE", shared_metrics_text)
        self.assertIn("LOAD_SHARED_GRANTS_TO_USERS", shared_metrics_text)
        self.assertIn("LIVE FALLBACK: SNOWFLAKE.ACCOUNT_USAGE.DATABASE_STORAGE_USAGE_HISTORY", shared_metrics_text)
        self.assertIn("WORKLOAD HEATMAP LIVE FALLBACK IS CAPPED AT 30 DAYS", shared_metrics_text)
