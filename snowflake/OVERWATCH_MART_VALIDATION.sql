...
WITH required_objects AS (
    SELECT * FROM VALUES
        ...
        ('TABLE', 'MART_QUERY_EVIDENCE_RECENT'),
        ('TABLE', 'MART_ALERT_EVIDENCE_RECENT'),
        ('TABLE', 'MART_SECURITY_EVIDENCE_RECENT'),
        ('TABLE', 'MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT'),
        ('TABLE', 'MART_COST_EVIDENCE_RECENT'),
        ('TABLE', 'MART_DBA_EVIDENCE_RECENT'),
        ...
        ('TABLE', 'MART_EXECUTIVE_COMMAND_CENTER_KPI'),
        ('TABLE', 'MART_EXECUTIVE_COMMAND_CENTER_TIMESERIES'),
        ('TABLE', 'MART_EXECUTIVE_COMMAND_CENTER_WAREHOUSE'),
        ('TABLE', 'MART_EXECUTIVE_COMMAND_CENTER_ALERTS'),
        ('TABLE', 'MART_EXECUTIVE_COMMAND_CENTER_CONTEXT'),
        ('VIEW', 'V_QUERY_DAILY_SUMMARY'),
        ('VIEW', 'V_WAREHOUSE_DAILY_CREDITS'),
        ('VIEW', 'V_CORTEX_DAILY_USAGE'),
        ('VIEW', 'V_USER_DISPLAY_DIM'),
        ('VIEW', 'V_LOGIN_SECURITY_DAILY'),
        ('VIEW', 'V_TASK_STATUS_DAILY'),
        ('VIEW', 'V_SECURITY_POSTURE_DAILY'),
        ('VIEW', 'V_EXECUTIVE_PACKET_CURRENT'),
...
actual_counts AS (
    ...
    WHERE TABLE_SCHEMA = CURRENT_SCHEMA()
      AND (
          ...
          OR TABLE_NAME ILIKE 'ALERT^_%' ESCAPE '^'
          OR TABLE_NAME ILIKE 'V^_%' ESCAPE '^'
      )
    UNION ALL
...
-- 2a) User-display and credential-expiration schema contract.
WITH required_columns AS (
    SELECT * FROM VALUES
        ('MART_USER_DIM_CURRENT', 'USER_NAME'),
        ('MART_USER_DIM_CURRENT', 'DISPLAY_NAME'),
        ('MART_USER_DIM_CURRENT', 'FIRST_NAME'),
        ('MART_USER_DIM_CURRENT', 'LAST_NAME'),
        ('MART_USER_DIM_CURRENT', 'USER_DISPLAY_NAME'),
        ('MART_USER_DIM_CURRENT', 'USER_CHART_LABEL'),
        ('MART_USER_DIM_CURRENT', 'USER_ADMIN_LABEL'),
        ('FACT_CORTEX_DAILY', 'USER_NAME'),
        ('FACT_CORTEX_DAILY', 'USER_DISPLAY_NAME'),
        ('FACT_CORTEX_DAILY', 'USER_CHART_LABEL'),
        ('FACT_CORTEX_DAILY', 'USER_EMAIL'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_ID'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_NAME'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'USER_NAME'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'USER_DISPLAY_NAME'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'USER_CHART_LABEL'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'EXPIRATION_DATE'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'DAYS_TO_EXPIRATION'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'EXPIRATION_BUCKET'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_EXPIRING_30D_FLAG'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_EXPIRING_7D_FLAG'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_EXPIRED_FLAG'),
        ('MART_SECURITY_CREDENTIAL_EXPIRATIONS_CURRENT', 'CREDENTIAL_EXPIRATION_SEVERITY'),
        ('MART_SECURITY_EVIDENCE_RECENT', 'USER_DISPLAY_NAME'),
        ('MART_SECURITY_EVIDENCE_RECENT', 'USER_CHART_LABEL'),
        ('MART_SECURITY_EVIDENCE_RECENT', 'CREDENTIAL_ID'),
        ('MART_SECURITY_EVIDENCE_RECENT', 'CREDENTIAL_TYPE'),
        ('MART_SECURITY_EVIDENCE_RECENT', 'EXPIRATION_DATE')
    AS t(TABLE_NAME, COLUMN_NAME)
)
SELECT
    'USER_DISPLAY_AND_CREDENTIAL_EXPIRATION_COLUMNS' AS CHECK_NAME,
...
WITH required_packet_fields AS (
  ...
  FROM VALUES
    ...
    ('SECURITY_CREDENTIALS_EXPIRING_30D_COUNT'), ('SECURITY_CREDENTIALS_EXPIRING_7D_COUNT'),
    ('SECURITY_CREDENTIALS_EXPIRED_COUNT'), ('SECURITY_CREDENTIAL_NEXT_EXPIRATION_TS'),
    ('SECURITY_CREDENTIAL_NEXT_EXPIRATION_USER'), ('SECURITY_CREDENTIAL_NEXT_EXPIRATION_TYPE'),
    ('SECURITY_CREDENTIAL_EXPIRATION_STATUS'), ('SECURITY_CREDENTIAL_EXPIRATION_FINDINGS'),
    ('SECURITY_CREDENTIAL_SOURCE_CONFIRMED_ZERO'), ('SECURITY_CREDENTIAL_SOURCE_STATUS'),
    ('SECURITY_CREDENTIAL_SOURCE_FRESHNESS_TS'), ('SECURITY_CREDENTIAL_SOURCE_LATENCY_NOTE')
),
...
UNION ALL
SELECT 'MART_EXECUTIVE_COMMAND_CENTER_KPI', COUNT(*), MAX(SNAPSHOT_TS) FROM MART_EXECUTIVE_COMMAND_CENTER_KPI
UNION ALL
SELECT 'MART_EXECUTIVE_COMMAND_CENTER_TIMESERIES', COUNT(*), MAX(SNAPSHOT_TS) FROM MART_EXECUTIVE_COMMAND_CENTER_TIMESERIES
UNION ALL
SELECT 'MART_EXECUTIVE_COMMAND_CENTER_WAREHOUSE', COUNT(*), MAX(SNAPSHOT_TS) FROM MART_EXECUTIVE_COMMAND_CENTER_WAREHOUSE
UNION ALL
SELECT 'MART_EXECUTIVE_COMMAND_CENTER_ALERTS', COUNT(*), MAX(SNAPSHOT_TS) FROM MART_EXECUTIVE_COMMAND_CENTER_ALERTS
UNION ALL
SELECT 'MART_EXECUTIVE_COMMAND_CENTER_CONTEXT', COUNT(*), MAX(SNAPSHOT_TS) FROM MART_EXECUTIVE_COMMAND_CENTER_CONTEXT;
...
WITH grant_proof AS (
    SELECT * FROM VALUES
        ...
        ('OVERWATCH_ADMIN', 40, 'GRANT USAGE ON WAREHOUSE WH_ALFA_OVERWATCH TO ROLE OVERWATCH_ADMIN;'),
        ('OVERWATCH_ADMIN', 50, 'GRANT OPERATE ON WAREHOUSE WH_ALFA_OVERWATCH TO ROLE OVERWATCH_ADMIN;'),
...
SELECT
    'EXECUTIVE_COMMAND_CENTER_PROCEDURE' AS CHECK_NAME,
    'SP_OVERWATCH_REFRESH_EXECUTIVE_COMMAND_CENTER' AS PROCEDURE_NAME,
    COUNT(*) AS MATCHING_PROCEDURES,
    IFF(COUNT(*) > 0, 'PASS', 'FAIL') AS VALIDATION_STATUS
FROM INFORMATION_SCHEMA.PROCEDURES
WHERE PROCEDURE_SCHEMA = CURRENT_SCHEMA()
  AND PROCEDURE_NAME = 'SP_OVERWATCH_REFRESH_EXECUTIVE_COMMAND_CENTER';
