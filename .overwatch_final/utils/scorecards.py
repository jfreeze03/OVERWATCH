...
DBA_CONTROL_PLANE_SECTION_NEXT_MOVES = {
    "DBA Control Room": "Promote command-queue triage into owned execution with named owners, approvals, and verified closure.",
    ...
    "Cost & Contract": "Add verified savings closure and optional CMDB owner enrichment beyond Snowflake tags.",
    ...
    "Account Health": "Replace static owner hints with live service/on-call owner integration and automated closure analytics.",
}
